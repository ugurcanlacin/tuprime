...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<c:url value="/admin-lte/plugins/iCheck/square/blue.css" />">
  ...
  <body class="login-page">
    ...
    <!-- iCheck -->
    <script src="<c:url value="/admin-lte/plugins/iCheck/icheck.min.js" />"></script>
    <script>
      $(function () {
        $('input').iCheck({
