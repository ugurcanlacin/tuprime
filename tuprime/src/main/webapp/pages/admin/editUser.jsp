        ...
        <div class="container">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<c:url value="/admin/usermanagement/edituser/${userForm.id}"/>">Kullanıcı Güncelle</a></li>
            </ol>
          </section>
          	<p>
	        ...
	        <section class="content">
	          <div class="row">
	           <div class="box box-info">
                ...
                <!-- form start -->
                <form:form class="form-horizontal" action="../edituser" method="post" commandName="userForm">
                  <div class="box-body">
                    <div class="form-group">
	                    <label for="name" class="col-sm-2 control-label">İsim</label>
	                    <div class="col-sm-4">
	   						<form:input path="name" id="name"  class="form-control" required="required" maxlength="64" value="${userForm.name}"/>
	                    </div>
                    	<label for="surname" class="col-sm-1 control-label">Soyisim</label>
	                    <div class="col-sm-4">
	                        <form:input path="surname" id="surname"  class="form-control" maxlength="64" value="${userForm.surname}"/>
	                    </div>
                    </div>
                    <div class="form-group">
	                    <label for="username" class="col-sm-2 control-label">Kullanıcı Adı</label>
	                    <div class="col-sm-4">
	   						<form:input path="username" id="username"  class="form-control" required="required" maxlength="64" value="${userForm.username}"/>
	                    </div>
                    	<label for=email class="col-sm-2 control-label">Email</label>
	                    <div class="col-sm-4">
	   						<form:input path="email" id="email"  class="form-control" required="required" maxlength="64" value="${userForm.email}"/>
	                    </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="active" id="active" value="true"  <c:if test="${userForm.active}">checked="checked"</c:if> /> Aktiflik
                          </label>
                        </div>
                      </div>
                    </div>
