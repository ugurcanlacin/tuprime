	          ...
	          <div class="row">
	           <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Yeni Diyet</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form:form class="form-horizontal" action="../editdiet" method="post" commandName="diet">
                  <div class="box-body">
                    <div class="form-group">
	                    <label for="diet" class="col-sm-2 control-label">Diyet</label>
	                    <div class="col-sm-4">
	   						<form:textarea value="${diet}" rows="7" cols="40" path="diet" id="diet"  class="form-control" required="required" maxlength="64"/>
