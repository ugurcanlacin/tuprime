	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="container">
				...
				<p>
					<a class="btn bg-olive margin"
						href="<c:url value="/user/dashboard"/>">Diyetlerim</a> <a
						class="btn btn-default" href="<c:url value="/user/workout"/>">Çalışma
						Programım</a> <a class="btn btn-default"
						href="<c:url value="/user/pdetail"/>">Kişisel Detaylarım</a>
				</p>
				<!-- Main content -->
